...
public class HomePage extends BaseClass {
  ...
  //--------------------------bug 1233-----------------------------------------------------
    ...
    @FindBy(partialLinkText = "Actu & Éco")
    private static WebElement cliquer_sur_actu_eco;

    @FindBy(xpath="/html/body/main/div/div[1]/div[3]/div[4]/div/div[1]/div/a")
    private static WebElement cliquer_sur_actualite;

    @FindBy(id="comment_comment")
    private static WebElement ecrire_un_commenataire;

    @FindBy(id="comment_submit")
    private static WebElement cliquer_sur_poster;

    @FindBy(className = "c-off-canvas__close")
    private static WebElement canvas_close ;

    @FindBy(className = "c-off-canvas--from-bottom")
    private static WebElement is_visible_canvas;

    @FindBy(className = "c-heading__text")
    private static WebElement number_comment;
    ...
    public static void setLogin (String login){
      nom_utilisateur1.sendKeys(login);
    }

    public static void close_modal() throws InterruptedException {
          Thread.sleep(5000);
          if (is_visible_canvas.isDisplayed()) {
    ...
    public static void setPassword(String password) {
      mot_de_passe2.sendKeys(password);
    }
    ...
    public static void setComment(String comment) {
        ecrire_un_commenataire.sendKeys(comment);
    }
    ...
    public static String get_Result_comment (){
          return number_comment.getText();
    }
